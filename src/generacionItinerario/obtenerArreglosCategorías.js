...
const seleccionarLugaresPorDistancia = async (idUsuario, numeroPersonas, restricciones, gradoAleatoriedad, nivelPresupuesto, esAltoPresupuesto, horaInicio, horaFin, fechaInicio, fechaFin, latitudInicial, longitudInicial) => {
    ...
    let a = 0.25;                                               // Si el lugar es deseado
    let b = 2;                                                  // Si el lugar está cerca (variable)
    let c = 0.25;                                               // Si el lugar está en las categorías favoritas
    let d = 0.25;                                               // Si el lugar cumple con las restricciones
    let e_weight = 10;                                          // Peso del precio
...
generarItinerario(1, 1, "2024-12-18", "2024-12-18", "09:00", "18:00", 50, 2, 2, 2000, {impedimentoFisico: false, familiar: false, vegetarianFriendly: false, petFriendly: false, goodForGroups: false}, 19.436511157306374, -99.13954113405046 );
