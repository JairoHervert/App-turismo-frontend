        ...
        <Grid container spacing={2} className='it_pa-planer-and-moreinfo-container'>
          ...
          <Grid className='it_pa-planer-container'>
            <Card>
              ...
              {activeTab === 'Plan' ? (
                <Planer idUsuario={idUsuario} setSelectedPlace={handlePlaceSelect} onSelectPlaces={setLugares} distanciasTiempos={distanciasTiempos} lugaresFiltrados={filteredLugares} onUpdateItinerario={handleItinerarioUpdate} onDeletePlace={handleDeletePlace} onUpdateDistanciasTiempos={handleUpdateDistanciasTiempos} idItinerario={idItinerario} />
              ) : (
        ...
        >
          ...
          <DialogContent>
            <DialogContentText id='finality-dialog-description'>
              <Typography fontFamily={'poppins'} className='fw-normal text-center'>Confirma si deseas finalizar este itinerario. Podrás consultarlo más tarde en la sección de itinerarios guardados</Typography>
            </DialogContentText>
          </DialogContent>
          <DialogActions>
            <ButtonsMod
